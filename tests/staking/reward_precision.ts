...
describe("staking reward precision", () => {
  ...
  const jupRewardDuration = new BN(7); // This create precision loss in reward_rate, which lead to remaining reward
  const xMerRewardDuration = new BN(7); // This create precision loss in reward_rate, which lead to remaining reward
